...
(function initDraggableWindows() {
    ...
    document.addEventListener('pointerdown', e => {
        ...
        // Convert any right/bottom CSS positioning to left/top before dragging
        // This prevents the window from jumping to left:0 on first drag
        dragWin.style.left = rect.left + 'px';
        dragWin.style.top = rect.top + 'px';
