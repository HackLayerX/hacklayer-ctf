...
contextBridge.exposeInMainWorld('ctfAPI', {
    ...
    // Copy a challenge's download link to the clipboard. navigator.clipboard is
    // not reliable here — the page is served over a custom protocol and the
    // window often isn't focused when the click lands — so it goes through the
